...
function createQuestion() {
    ...
    var t = document.createTextNode(sessionStorage.page);
    currentPage.appendChild(t);

    var progressBar = document.getElementById('progress-bar');
    progressBar.style.width = parseInt(sessionStorage.page / 9 * 100) + '%';
...
function createResult() {
    ...
    document.getElementById('type01').appendChild(document.createTextNode(sessionStorage.q1));
    document.getElementById('type02').appendChild(document.createTextNode(sessionStorage.q2));
    document.getElementById('type03').appendChild(document.createTextNode(sessionStorage.q3));
    document.getElementById('type04').appendChild(document.createTextNode(sessionStorage.q4));
    document.getElementById('type05').appendChild(document.createTextNode(sessionStorage.q5));
    document.getElementById('type06').appendChild(document.createTextNode(sessionStorage.q6));
    document.getElementById('type07').appendChild(document.createTextNode(sessionStorage.q7));
    document.getElementById('type08').appendChild(document.createTextNode(sessionStorage.q8));
    document.getElementById('type09').appendChild(document.createTextNode(sessionStorage.q9));
}